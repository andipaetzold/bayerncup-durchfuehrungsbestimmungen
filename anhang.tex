...
\begin{itemize}
	\item In welche Wertung (BIC, BIC AK, KIC, SIC, TEAMs on Skates) fließen die Gesamtwertungen der Veranstaltung ein
...
\begin{tabular}{|l|l|l|}
	...
	Cadetten       & 13 bis 14 Jahre & 10.000m \\ \hline
	...
	Senioren       & ab 35 Jahre & keine Einschränkung \\ \hline
\end{tabular}
\end{center}
...
\subsection{BIC AK}
Wie~\ref{subsec:bic-notwendige-ergebnisse}
...
In der Saison 2023 werden für die folgenden BIC Veranstaltungen die Punkte nach Platzierung vergeben (siehe Anhang~\ref{sec:appendix-punkte-nach-platz}) und zusätzlich werden noch mögliche Bonuspunkte addiert (siehe Anhang~\ref{sec:appendix-punkte-nach-zeit}):
